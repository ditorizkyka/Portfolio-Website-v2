...
const HeroSection = () => {
  ...
  return (
    <div className="mb-16  md:px-0" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
      {isMobile ? (
        // === MOBILE UI ===
  ...
  >
    ...
    <ScrambleText text="EMAIL ME" className="text-sm text-[#CCCCCC]" />
  </a>
  ...
  >
    <WhatsAppIcon />
    <ScrambleText text="CONTACT ME" className="text-sm text-[#CCCCCC]" />
  </a>
</div>
        ...
        // === DESKTOP UI ===
        <div className="flex flex-row items-center space-x-8 text-left">
          ...
          <div style={{ fontFamily: "'Space Grotesk', sans-serif", wordSpacing: '-1px' }}>
            ...
            <div className="flex space-x-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#141415] px-6 py-3 rounded-lg flex items-center space-x-2"
              >
                <WhatsAppIcon />
                <ScrambleText text="CONTACT ME" className="text-sm text-[#CCCCCC]" />
              </a>
